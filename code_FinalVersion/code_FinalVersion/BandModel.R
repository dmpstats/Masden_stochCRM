...
iter<- 10 ##enter number of iterations required

## set collision risk species
CRSpecies = c("Black_legged_Kittiwake")# "Northern_Gannet", "Arctic_Skua", "Northern_Fulmar", "Great_Black_backed_Gull", "Common_Guillemot", "Lesser_Black_Backed_Gull", "Little_Auk", "Great_Skua", "Atlantic_Puffin", "Razorbill")
...
WFWidth = 10 #### Used in Large Array Correction 
...
for (s in 1 : length (CRSpecies)){
  ...
  FlightHeightSpec = read.table(ht, header = T, sep = ",") #and change in option2 code
